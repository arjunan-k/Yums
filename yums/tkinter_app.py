...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        # text widget
        self.text_widget = Text(self.window, width=20, height=2, bg=BG_COLOR, fg=TEXT_COLOR, font=FONT, padx=10, pady=5)
        ...
        self.msg_entry.place(relwidth=0.74, relheight=0.06, rely=.008, relx=.011)
        ...
        send_button.place(relx=0.77, relwidth=0.22, relheight=0.06, rely=0.008)
